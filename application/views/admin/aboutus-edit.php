...
<div class="pd-20">
	<div class="form form-horizontal" id="form-article-add">
		<input id="id" type="hidden" value="<?php echo $aboutus->id;?>">
	    <div class="row cl">
	      ...
	      <div class="formControls col-2"> <span class="select-box">
	        <select id="role" class="select" size="1" name="demo1" datatype="*" nullmsg="请选择客户端！">
	          ...
	          <option value="2" <?php echo $aboutus->role=='2'?'selected':'';?>>用户</option>
	          <option value="1" <?php echo $aboutus->role=='1'?'selected':'';?>>超市</option>
	          <option value="0" <?php echo $aboutus->role=='0'?'selected':'';?>>物流</option>
	        </select>
	        </span> </div>
	      <div class="col-4"> </div>
	    </div>
		<div class="row cl">
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value="<?php echo $aboutus->version;?>" placeholder="" id="version" name="" nullmsg="请输入版本！">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>logo：</label>
			<div class="formControls col-10">
                <img src="<?php echo $aboutus->logo;?>" id="thumbnail" style="max-width:90%;max-height:100px;">            
		...
		<div class="row cl">
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value="<?php echo $aboutus->appname;?>" placeholder="" id="appname" name="" nullmsg="请输入App名称！">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">内容：</label>
			<div class="formControls col-10">
				<textarea id="content" name="" cols="" rows="" class="textarea"><?php echo $aboutus->content;?></textarea>
			</div>
		</div>
		<div class="row cl">
