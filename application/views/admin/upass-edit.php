...
<div class="pd-20">
  <div class="form form-horizontal" id="form-member-add">
    <input id="id" value="<?php echo $upass->id;?>" type="hidden">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <!-- <input type="text" class="input-text" value="<?php echo $class->name;?>" placeholder="" id="className" name="className" datatype="*2-16" ignore="ignore" nullmsg="班级不能为空"> -->
        <span><?php echo $upass->bigclass;?></span>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $upass->score_ordinary;?>" placeholder="" id="score_ordinary" name="score_ordinary" datatype="*1-6" ignore="ignore" nullmsg="平时成绩不能为空">
        <!-- <span><?php echo $upass->score_ordinary;?></span> -->
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $upass->score_term;?>" placeholder="" id="score_term" name="score_term" datatype="*1-6" ignore="ignore" nullmsg="期末成绩不能为空">
        <!-- <input type="text" class="input-text" value="<?php echo $class->name;?>" placeholder="" id="className" name="className" datatype="*2-16" ignore="ignore" nullmsg="班级不能为空"> -->
        <!-- <span><?php echo $upass->score_term;?></span> -->
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $upass->score;?>" placeholder="" id="score" name="score" datatype="*1-6" ignore="ignore" nullmsg="总评不能为空">
        <!-- <input type="text" class="input-text" value="<?php echo $class->name;?>" placeholder="" id="className" name="className" datatype="*2-16" ignore="ignore" nullmsg="班级不能为空"> -->
        <!-- <span><?php echo $upass->score;?></span> -->
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <!-- <input type="text" class="input-text" value="<?php echo $class->name;?>" placeholder="" id="className" name="className" datatype="*2-16" ignore="ignore" nullmsg="班级不能为空"> -->
        <span><?php echo $upass->examproperty;?></span>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      <div class="col-9 col-offset-3">
        <button onClick="saveUpass(false);" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存 </button>
