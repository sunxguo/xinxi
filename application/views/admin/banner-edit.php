	...
	<div class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo $banner->title;?>" placeholder="" id="title" name="">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
                <img src="<?php echo $banner->thumbnail;?>" id="thumbnail" style="max-width:90%;max-height:100px;">            
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onClick="saveBanner(false,false);" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并发布</button>
				<button onClick="saveBanner(false,true);" class="btn btn-secondary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存草稿</button>
