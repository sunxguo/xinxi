		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td><img src="/assets/temp/brand/dongpeng.jpeg"></td>
					<td class="text-l"><img title="国内品牌" src="/assets/images/gq/cn.gif"> 东鹏</td>
...
<script type="text/javascript" src="/assets/js/H-ui.admin.product.js"></script>
