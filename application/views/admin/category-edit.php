...
<div class="pd-20">
  <form action="?id=<?php echo $category->id;?>" class="form form-horizontal" id="form-member-add">
      ...
      <div class="formControls col-5"> <span class="select-box">
        <select id="supermarket" class="select" size="1" name="demo1" datatype="*" nullmsg="请选择超市！">
          ...
          <optgroup label="<?php echo $sm->name;?>">
            ...
            <option value="<?php echo $ssm->id;?>" <?php echo $ssm->id==$category->sid?'selected':'';?>><?php echo $ssm->sname;?></option>
            <?php endforeach;?>
          </optgroup>
          <?php endforeach;?>
        </select>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $category->name;?>" placeholder="" id="name" name="name" datatype="*2-16" nullmsg="名称不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
